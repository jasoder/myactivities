...
from app.api.routers import athletes, completed_activities, planned_activities, activities, strava
...
api_router.include_router(strava.router, prefix="/strava", tags=["Strava Integration"])
